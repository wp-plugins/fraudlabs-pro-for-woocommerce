...
This plugin is an add-on for WooCommerce that help you to screen your order transaction, such as credit card transaction, for online fraud. Its sophisticated and advance engines perform a comprehensive validation from all elements, such as geolocation, proxy, email, blacklisted, BIN, velocity, and many more to accurately unveil a fraud order. The plugin will then display the screening result on WooCommerce order page for your review.
